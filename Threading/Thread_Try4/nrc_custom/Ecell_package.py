...
class ECell:       
    ...
    def __init__(self, cell_name, com_port):
        ...
        self.command_TravelSettings_Deposition_Set = b'\x10\x02\x00\x88\x1A\x07\x00\x00\x00\x00\x00\x00\x00\x99\x20\x00\x00\xff\x00\x00\x00\x64\x00\xA5\xA0\x1c'
        # Current settings - Char Full = 44200, Char Slide = 41000
        # Current settings - Depo Full = 42400, Depo Slide = 39200
